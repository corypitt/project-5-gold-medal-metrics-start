...
const createCountryTable = () => {
  ...
  return "CREATE TABLE 'Country' (id INTEGER NOT NULL, name TEXT NOT NULL, code TEXT NOT NULL, gdp INTEGER, " +
      "population INTEGER, PRIMARY KEY(id));";
};
...
const createGoldMedalTable = () => {
  return "CREATE TABLE 'GoldMedal' (id INTEGER NOT NULL, year INTEGER NOT NULL, city TEXT NOT NULL, season TEXT NOT NULL, " +
      "name TEXT NOT NULL, country TEXT NOT NULL, gender TEXT NOT NULL, sport TEXT NOT NULL, " +
      "discipline TEXT NOT NULL, event TEXT NOT NULL, PRIMARY KEY(id));";
};
...
const numberMenMedalists = country => {
  return `SELECT gender, COUNT(DISTINCT name) as count FROM GoldMedal WHERE country = '${country}' AND gender = 'Men'
...
const numberWomenMedalists = country => {
  return `SELECT gender, COUNT(DISTINCT name) as count FROM GoldMedal WHERE country = '${country}' AND gender = 'Women'
  GROUP BY gender ORDER BY count DESC LIMIT 1;`;
};
